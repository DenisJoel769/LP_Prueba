<template>
  ...
  necesitando el tiempo de espera?"></speech>
          ...
          <div class="d-block tituloRetencion font-weight-bold text-center">
        ...
        <v-card-actions class="mt-n8">
          ...
          <v-btn @click="cerrarModal" fab dark x-small elevation="2" color="#dc0000">
            <v-icon>fa-times</v-icon>
          </v-btn>
            <!-- <router-link :to="{name:'Bienvenido'}" class="Llamada Entrante">
          <v-btn fab dark x-small elevation="2" color="#dc0000"> 
    ...
    <v-row>
      ...
      <v-row class="justify-end mt-5">
          <input type="checkbox" class="btncheckbox" @click="selectAllCheckbox"
          v-model="allCheck">      
      </v-row>
    ...
    <v-row class="justify-center mt-3" style="height: 350px">
      <v-data-table height="340" fixed-header :headers="headers" :items="boletasTabla" :class="tableClass"
        hide-default-footer :items-per-page="-1" style="background: transparent; width: 100% " refresh>
        <template v-slot:item="props">
          ...
          <tr :class="
            ...
            <td>
              ...
              <div v-if="props.item.idEstadoEmpenho === 12">
...
<v-row  justify="end"> 
  ...
  <v-row justify="end"  class="mt-15" align="center">
        <!-- <v-btn
        small color="primary" class="text-none mr-15" @click="SolicitudGenerada()"
        >VR</v-btn> -->
        ...
        <v-btn small color="error" class="text-none ms-2 mr-7" @click="dialogCancelar = true">Cancelar</v-btn>
           ...
           <v-btn color="success" small class="text-none ma-2 mr-5" :disabled="btnDisable"
...
<!--        
    ...
    <v-row class="mb-n5 mt-15">
      ...
      <!-- le pongo colores a las boletas  -->
      ...
      <v-slide-group class="iconSlideBoleta" prev-icon="fa-caret-left" next-icon="fa-caret-right" show-arrows="always">
        <v-slide-item v-for="(boleta) in boletasRetencion" :key="boleta.idEmpenho">
          <v-card elevation="0" class="ml-10 iconCardBoleta rounded-lg" width="100" height="100"
            :color="boleta.idEstadoEmpenho == 13 ? 'rgb(240, 37, 37)': '#5FA21D'">
...
<script src="./Retencion.js"></script>
